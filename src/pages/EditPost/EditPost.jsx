...
const EditPost = () => {
  ...
  const handleSubmit = (e) => {
   ...
   let validationError = "";
    ...
    validationError = "A imagem precisa ser uma URL válida.";
    }
  ...
  return (
    <div className={styles.edit_post}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label >
          <span>Conteúdo:</span>
          <textarea name="body" required placeholder="Insira o conteúdo do post" onChange={(e) => setBody(e.target.value)} value={body}></textarea>  </label>
        <label >
          <span>Tags:</span>
